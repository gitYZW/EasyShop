...
<body>
	<!-- header -->
	<div class="header">
		<a href="http://www.e3mall.cn"><br/><img src="/images/logo.png" border="0"><span style="padding-top:10px">欢迎登录</span></a>
	</div>
	<!-- login_main -->
	...
	<div class="footer">
		...
		<p>
			广州EasyShop电子商务有限公司<br>
			 Copyright© EasyShop商城
			easyshop.cn 版权所有<br>
		</p>
	</div>
	<!-- /footer -->
